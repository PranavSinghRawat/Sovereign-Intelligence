...
- Name: chat.spec.ts >> Sovereign Intelligence Layer - Landing Page E2E Suite >> should render the P2P secure connections widget inside the sidebar
- Location: src/__tests__/e2e/chat.spec.ts:15:7
...
Locator: locator('text=P2P Secure Connection')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=P2P Secure Connection')
