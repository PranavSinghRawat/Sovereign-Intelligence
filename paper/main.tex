...
\begin{tikzpicture}[
    ...
    block/.style = {rectangle, draw=blue!50!black, fill=blue!5, text width=6.5em, text centered, rounded corners, minimum height=2.2em, drop shadow={opacity=0.15, shadow xshift=0.07cm, shadow yshift=-0.07cm}},
    database/.style = {cylinder, draw=gray!50!black, fill=gray!10, shape border rotate=90, text width=5.5em, text centered, minimum height=2.2em, drop shadow={opacity=0.15, shadow xshift=0.07cm, shadow yshift=-0.07cm}}
]
